...
module load flatbuffers/22.9.24 python/3.10.2 swig/4.0.2 

ROOT_DIR=$HOME/projects/def-svassili/Test
...
cd $ROOT_DIR/chrono && git submodule init && git submodule update
